...
<span class="author">by <?php the_author_posts_link(); ?></span>
				...
				if (option::get('post_views') == 'on') { ?><span class="views">Views: <?php printf( get_post_meta( get_the_ID(), 'Views', true ) );  ?></span><?php }
				?>
			...
			<?php if ( option::get('post_share') == 'on' ) {
				...
				?><div id="socialicons">
					...
					<ul class="wpzoomSocial">
						<li><a href="http://twitter.com/share" data-url="<?php the_permalink(); ?>" class="twitter-share-button" data-count="horizontal"  data-via="BA_Confidential">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></li>
