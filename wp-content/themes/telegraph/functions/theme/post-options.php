...
function custom_add_save($postID){
	...
	if ($_POST['save'] || $_POST['publish']) {
		...
		update_custom_meta($postID, $_POST['wpzoom_post_type'], 'wpzoom_post_type');
	}
}
...
function wpzoom_post_options() {
	...
	<fieldset>
		<div>
			...
			<p>
			<label for="wpzoom_post_type" >Post Type (icon):</label><br />
			<select name="wpzoom_post_type" id="wpzoom_post_type">
				<option<?php selected( get_post_meta($post->ID, 'wpzoom_post_type', true), 'Default' ); ?>>Default (no icon)</option>
				<option<?php selected( get_post_meta($post->ID, 'wpzoom_post_type', true), 'Attachment' ); ?>>Attachment</option>
				<option<?php selected( get_post_meta($post->ID, 'wpzoom_post_type', true), 'Audio' ); ?>>Audio</option>
				<option<?php selected( get_post_meta($post->ID, 'wpzoom_post_type', true), 'Event' ); ?>>Event</option>
				<option<?php selected( get_post_meta($post->ID, 'wpzoom_post_type', true), 'Video' ); ?>>Video</option>
			</select>
			</p>
  		</div>
	</fieldset>
