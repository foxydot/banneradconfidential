<?php
add_action('widgets_init', 'tmnf_homepage_2col_alt_load_alt_widgets');

function tmnf_homepage_2col_alt_load_alt_widgets()
{
	register_widget('tmnf_Homepage_2col_Widget_alt');
}

class tmnf_Homepage_2col_Widget_alt extends WP_Widget {
	
	function tmnf_Homepage_2col_Widget_alt()
	{
		$widget_ops = array('classname' => 'tmnf_homepage_2col_alt', 'description' => 'Homepage 2 Categories widget (Alternative).');

		$control_ops = array('id_base' => 'tmnf_homepage_2col_alt-widget');

		$this->WP_Widget('tmnf_homepage_2col_alt-widget', 'Themnific - Homepage Posts 3', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_excerpt'); ?>">Show thumbnails</label>
		</p>
