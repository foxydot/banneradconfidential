...
class AdWidget125_left extends WP_Widget {
	...
	function AdWidget125_left() {
		...
		parent::WP_Widget(false, __('Themnific - Ads 125px 4x', ''),$widget_ops);      
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Example', 'example'), 'image' => '', 'image2' => '','image3' => '', 'image4' => '', 'href' => '', 'href2' => '', 'href3' => '', 'href4' => '' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image' ); ?>"><?php _e('Image URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'href' ); ?>"><?php _e('Target URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image2' ); ?>"><?php _e('Image 2 URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'href2' ); ?>"><?php _e('Target 2 URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image3' ); ?>"><?php _e('Image 3 URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'href3' ); ?>"><?php _e('Target 3 URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image4' ); ?>"><?php _e('Image 4 URL', 'example'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'href4' ); ?>"><?php _e('Target 4 URL', 'example'); ?></label>
