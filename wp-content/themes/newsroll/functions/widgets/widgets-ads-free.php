...
class AdWidget_Free extends WP_Widget {

	function AdWidget_Free() {
		$widget_ops = array('description' => 'Use this widget to add Ad as a widget.' );
		parent::WP_Widget(false, __('Themnific - Ads Widget Free', ''),$widget_ops);      
	}
	...
	function widget($args, $instance) {  
		...
		<?php } else { ?>
			...
			<a href="<?php echo $href; ?>"><img class="adFree" src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></a>
