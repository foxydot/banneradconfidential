...
class AdWidget_300 extends WP_Widget {
	...
	function AdWidget_300() {
		...
		parent::WP_Widget(false, __('Themnific - Ads Widget 300px', ''),$widget_ops);      
	}
	...
	function widget($args, $instance) {  
		...
		if($title != '')
			echo '<h4 class="homepage"><span class="inn">'.$title.'</span></h4>';
		...
		<?php } else { ?>
			...
			<a href="<?php echo $href; ?>"><img class="ad300 twinsbox" src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></a>
