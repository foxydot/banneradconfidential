...
class Pages extends WP_Widget {
   ...
   function Pages() {
       ...
       parent::WP_Widget(false, __('Themnific - Pages', ''),$widget_ops);      
   }
   ...
   function widget($args, $instance) {  
	...
	?>
        ...
        <ul class="lists">
        	<?php wp_list_pages('sort_column=menu_order&depth='.$depth.'&title_li') ?>
        </ul>
		</div>
   ...
   function form($instance) {
       ...
       <p>
	   	   <label for="<?php echo $this->get_field_id('depth'); ?>"><?php _e('Levels of Pages:',''); ?></label>
